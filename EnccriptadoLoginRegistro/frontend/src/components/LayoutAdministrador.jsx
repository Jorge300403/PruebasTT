                            ...
                            <div className="card col-12 col-md-10 shadow-lg d-flex flex-column justify-content-between" id="card-menu">
                                ...
                                <div className="mx-4 mb-4">
                                    <div
                                        ...
                                        className={`link-card-menu d-flex align-items-center mb-4 ${esActivo("/administrador/lista-oncologos")}`}
                                    >
                                        <i className="bi bi-list" style={{ color: "white", fontSize: "2rem", marginRight: "8px" }}></i>
                                        <p className="mb-0 label-editar-oncologo texto-blanco fs-5">Ver lista de oncologos</p>
                                    </div>

                                    <div
                                        onClick={() => navigate("/administrador/cargar-datos-entrenamiento")}
                                        className={`link-card-menu d-flex align-items-center mb-4 ${esActivo("/administrador/cargar-datos-entrenamiento")}`}
                                    >
                                        <i className="bi bi-plus-circle" style={{ color: "white", fontSize: "2rem", marginRight: "8px" }}></i>
                                        <p className="mb-0 label-editar-oncologo texto-blanco fs-5">Agregar datos de entrenamiento</p>
                                    </div>
                                </div>
